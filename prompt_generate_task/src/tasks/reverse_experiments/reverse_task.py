...
def generate_alt_examples(name: str, description: str, templates: List[str], p2d: bool) -> List[Dict[str, str]]:
    ...
    for template in templates:
        prompt = generate_prompt_to_fill_template(template, description, p2d)
        ...
        try:
            ...
            modified = modified.replace("<name>", name)  # 👈 补这一句
        ...
        results.append(format_prompt_from_full_sentence(template, name, modified))
